 ...
 *
 * Description:
 *     This program implements a Caesar cipher encoder that can either encode
 *     a message with a specific offset or attempt all possible encodings (brute
